...
<div class="container">
    ...
    <div class="form-part">
        ...
        <!-- --------------------------- form -------------------------------- -->
        <div class="form">
            <form action="{{ route('travel-form.update',auth()->user()->id) }}" method="POST"
            ...
            <!-- --- form --- -->
                ...
                <div class="form-group">
                    <label for="exampleFormControlFile1">Image/PDF of E-ticket number</label><br>
                    <span
                        style="display: none">{{ $ticket_number = pathinfo(asset('storage/'.$travel->ticket_number),PATHINFO_EXTENSION) }}</span>

                    @if($ticket_number == 'jpeg' || $ticket_number == 'jpg' || $ticket_number == 'png')

                        <img src="{{asset('storage/'.$travel->ticket_number) }}" alt="No image"
                             style="width: 250px; height: 250px">

                    @else
                        <a href="{{ asset('storage/'.$travel->ticket_number) }}">View File</a><br>
                        <a href="{{ asset('storage/'.$travel->ticket_number) }}" download="">Download File</a>
                    @endif
                </div>


                <div class="form-group">
                    <label for="">Update info of E-ticket number (if needed) *</label>
                    <input
                        type="file"
                        class="form-control"
                        id="ticket_number"
                ...
                <div class="form-group">
                    <label for=""
                    >E-ticket number (text format) *</label
                    >
                    <input
                        type="text"
                        class="form-control"
                        ...
                        value="{{ $travel->ticket_number_text }}"
            ...
            <!-- --- form --- -->
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ $travel->date_of_departure }}"
            ...
            <!-- --- form --- -->
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ $travel->port_of_embarkation }}"
            ...
            <!-- --- form --- -->
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ $travel->port_of_disembarkation }}"
            ...
            <!-- --- form --- -->
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ $travel->approximate_distance }}"
                    />
                </div>
